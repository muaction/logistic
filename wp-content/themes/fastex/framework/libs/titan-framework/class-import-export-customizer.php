...
if ( !function_exists( 'thim_add_customizer_menu' ) ) :
	function thim_add_customizer_menu() {
		add_theme_page( __( 'Export Settings', 'thim' ), __( 'Export Settings', 'thim' ), 'edit_theme_options', 'export_settings', 'thim_customizer_export_theme_settings' );
	}
endif;
add_action( 'admin_menu', 'thim_add_customizer_menu', 1000 );

if ( !function_exists( 'thim_ajax_url' ) ) :
	function thim_ajax_url() {
		echo '<script type="text/javascript">
        var ajax_url ="' . get_site_url() . '/wp-admin/admin-ajax.php";
        var export_url = "' . get_site_url() . '/wp-admin/themes.php?page=export_settings";
        </script>';
	}
endif;
