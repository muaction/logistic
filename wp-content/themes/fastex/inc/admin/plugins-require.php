...
function tp_register_required_plugins() {
	$plugins = array(
		// Premium Plugins packed with the theme
		array(
		...
		array(
			'name'               => 'Thim Import Demo Data', // The plugin name
			'slug'               => 'thim-import-demo', // The plugin slug (typically the folder name)
			'source'             => get_template_directory() . '/inc/plugins/thim-import-demo.zip', // The plugin source
			'required'           => true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			'name'               => 'Less PHP Compiler', // The plugin name
			'slug'               => 'lessphp', // The plugin slug (typically the folder name)
			'source'             => 'https://downloads.wordpress.org/plugin/lessphp.2.0.0.zip', // The plugin source
		...
		array(
			'name'               => 'Our Team by ThimPress', // The plugin name
			'slug'               => 'thim-our-team', // The plugin slug (typically the folder name)
			'source'             => get_template_directory() . '/inc/plugins/thim-our-team.zip', // The plugin source
			'required'           => true, // If false, the plugin is only 'recommended' instead of required
			'version'            => '1.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			'name'               => 'FastEx Shortcodes by ThimPress', // The plugin name
			'slug'               => 'thim-fastex-shortcodes', // The plugin slug (typically the folder name)
			'source'             => get_template_directory() . '/inc/plugins/thim-fastex-shortcodes.zip', // The plugin source
			'required'           => true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-quick-view.1.0.8.zip', // The plugin source
