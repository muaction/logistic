 ...
 * @return string
 */
function ts_shortcode_images( $atts ) {
	...
	$animation = thim_getCSSAnimation( $images['animation'] );
	// get images
	$image_size = 'full';
	if ( $images['size'] ) {
	...
	$html    = '<ul class="thim-images-gallery-grid ' . $animation . ' '.$el_class.'">';
	$percent = 100 / $cell;
...
add_shortcode( 'thim-images', 'ts_shortcode_images' );
